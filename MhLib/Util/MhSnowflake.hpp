#ifndef MHSNOWFLAKE_HPP
#define MHSNOWFLAKE_HPP
#include <cstdint>
#include <chrono>
#include <stdexcept>
#include <mutex>
//! Shamelessly stolen from https://github.com/sniper00/snowflake-cpp
//! Usage notes at: https://github.com/sniper00/snowflake-cpp/blob/master/README.md
namespace MH33 {
namespace Util {

class SnowflakeDummyLock
{
public:
	void lock()
	{
...
template<int64_t Twepoch, typename Lock = SnowflakeDummyLock>
class Snowflake
{
