...
public:
	...
	MH33::GFX::sUnindexedMesh createUnindexedMesh(const MH33::GFX::VertexDescriptor* vertexDescriptor) override;
	MH33::GFX::sUnindexedMesh createUnindexedMesh(const MH33::GFX::VertexDescriptor* vertexDescriptor, const std::span<const std::byte>& vertexData) override;
	MH33::GFX::sIndexedMesh createIndexedMesh(const MH33::GFX::VertexDescriptor* vertexDescriptor) override;
	MH33::GFX::sIndexedMesh createIndexedMesh(const MH33::GFX::VertexDescriptor* vertexDescriptor, const std::span<const std::byte>& vertexData, const std::span<const uint32_t>& indices) override;
