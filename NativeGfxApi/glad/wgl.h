 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_create_context,WGL_ARB_extensions_string,WGL_EXT_extensions_string' c --alias --loader
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_create_context%2CWGL_ARB_extensions_string%2CWGL_EXT_extensions_string&generator=c&options=ALIAS%2CLOADER
 *
 */
